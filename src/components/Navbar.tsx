    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-zinc-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <div className="w-9 h-9 rounded-full bg-red-600 flex items-center justify-center text-white font-black text-lg shadow-md shadow-red-100 group-hover:scale-105 transition-transform">
              <span>P</span>
            </div>
