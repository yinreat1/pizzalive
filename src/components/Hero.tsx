...
import { Phone, ArrowRight, Clock, Utensils, Star, Flame } from 'lucide-react';
          ...
          <div className="flex flex-col items-center text-center max-w-2xl mx-auto relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3.5 w-full max-w-md justify-center mb-10">
              ...
              <a
                ...
                className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-white text-zinc-900 hover:bg-zinc-100 font-bold text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2 shadow-md"
              >
