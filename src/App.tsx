...
function MainWebsiteContent({
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 font-sans antialiased selection:bg-red-600 selection:text-white relative pb-32 md:pb-0">
      {/* Top Sticky Navbar */}
      <Navbar
...
export default function App() {
  const [currentPath, setCurrentPath] = useState(() => {
    return window.location.hash.toLowerCase() === '#admin' ? '/admin' : '/';
  });
